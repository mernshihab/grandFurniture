...
import { useDeleteFeatureMutation, useGetFeaturesQuery } from "../../../Redux/feature/featureApi";

export default function FeaturesList() {
  const { data, isLoading, isError, isSuccess } = useGetFeaturesQuery();
  const projects = data?.data;

  const [deleteProject] = useDeleteFeatureMutation();
          ...
          <tr key={project?._id}>
            ...
            <td>
              <div className="flex items-center gap-3">
                <Link to={`/admin/feature/edit/${project?._id}`}>
